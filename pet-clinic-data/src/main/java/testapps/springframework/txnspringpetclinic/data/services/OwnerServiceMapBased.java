...
@Service
public class OwnerServiceMapBased extends AbstractMapLongIdService<Owner> implements OwnerCrudService {

    public OwnerServiceMapBased(MapIdLongService<Owner> mapIdLongService) {
