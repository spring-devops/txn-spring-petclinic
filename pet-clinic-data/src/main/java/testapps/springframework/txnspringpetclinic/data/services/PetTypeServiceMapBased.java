...
@Service
public class PetTypeServiceMapBased extends AbstractMapLongIdService<PetType> implements PetTypeCrudService {

    public PetTypeServiceMapBased(MapIdLongService<PetType> mapIdLongService) {
